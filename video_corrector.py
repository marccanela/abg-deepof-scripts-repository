...
directory = "//FOLDER/becell/Lab Projects/ERCstG_HighMemory/Data/Marc/1) SOC/2023-10 - TRAP2/Female/DeepOF/corrected/"
...
def add_blank_frames(video_path, missing_frames):
    ...
    string = f"Modified video saved at {video_path} with {missing_frames} blank frames at the beginning."
    print(string)
...
with open(directory + "Summary of corrected videos.csv", "w") as file:
